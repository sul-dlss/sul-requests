...
ActiveRecord::Schema[8.1].define(version: 2026_07_22_175759) do
  ...
  create_table "stub_aeon_client_activities", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.text "data"
    t.datetime "updated_at", null: false
  end

  create_table "stub_aeon_client_appointments", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.text "data"
    t.datetime "updated_at", null: false
  end

  create_table "stub_aeon_client_queues", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.text "data"
    t.datetime "updated_at", null: false
  end

  create_table "stub_aeon_client_reading_rooms", force: :cascade do |t|
    t.text "closures"
    t.datetime "created_at", null: false
    t.text "data"
    t.datetime "updated_at", null: false
  ...
  create_table "stub_aeon_client_requests", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.text "data"
    t.datetime "updated_at", null: false
  end

  create_table "stub_aeon_client_users", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.text "data"
    t.datetime "updated_at", null: false
    t.string "username"
    t.index ["username"], name: "index_stub_aeon_client_users_on_username", unique: true
  end
