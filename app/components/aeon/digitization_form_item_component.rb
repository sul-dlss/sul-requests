...
module Aeon
  ...
  class DigitizationFormItemComponent < ViewComponent::Base
    ...
    attr_reader :item_label, :dom_id, :request, :base_name

    def initialize(dom_id:, item_label: nil, request: nil, base_name: nil, accordion: true)
    ...
    def item_label_element_id
      "digitization-item-label-#{dom_id}"
    end

    def delete_label_element_id
      "digitization-delete-label-#{dom_id}"
    end
  end
end
