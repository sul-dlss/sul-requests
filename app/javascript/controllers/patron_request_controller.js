...
export default class extends Controller {
  ...
  emptyFields(accordion) {
    ...
    return Array.from(accordion.querySelectorAll('[required],input[name="patron_request[item_ids][]"],input[name="patron_request[activity_ids][]"]')).find(x => formData.getAll(x.name).every(x => !x))
  }
