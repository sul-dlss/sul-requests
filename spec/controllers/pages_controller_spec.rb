    ...
    describe 'by sso users' do
      ...
      let(:folio_holding_response) do
        {"instanceId"=>"f1c52ab3-721e-5234-9a00-1023e034e2e8",
          ...
          "natureOfContent"=>[],
          "holdings"=>
           [{"id"=>"8b4ecc0a-b6c0-5856-be95-aa68cc4042fb",
             "notes"=>[],
             "location"=>
              {"effectiveLocation"=>
                {"code"=>"GRE-SSRC-SSDS",
                 "name"=>"Green Library Velma Denning Room (Social Science Data and Software)",
               ...
               "temporaryLocation"=>{}},
             "formerIds"=>[],
             "callNumber"=>{"typeId"=>"95467209-6d7b-468b-94df-0f5d7ad2747d", "typeName"=>"Library of Congress classification"},
             "copyNumber"=>"4",
             "holdingsType"=>"Serial",
             "electronicAccess"=>[],
             "statisticalCodes"=>[],
             "holdingsStatements"=>[{"statement"=>"1 computer disk"}],
             "suppressFromDiscovery"=>false,
             "holdingsStatementsForIndexes"=>[],
             "holdingsStatementsForSupplements"=>[]},
            {"id"=>"b20a4408-d807-5c68-ba8e-e680dfc414bb",
             "notes"=>[],
             "location"=>
              {"effectiveLocation"=>
                {"code"=>"GRE-SSRC-SSDS",
             ...
             "suppressFromDiscovery"=>false,
             "holdingsStatementsForIndexes"=>[],
             "holdingsStatementsForSupplements"=>[{"statement"=>"\"Codebook\""}]},
            {"id"=>"d1d495e8-7436-540b-a55a-5dfccfba25a3",
             "notes"=>[],
             "location"=>
              {"effectiveLocation"=>
                {"code"=>"GRE-SSRC-SSDS",
